...
const CourseDetails = () => {
  ...
  const [isAlreadyEnrollred, setIsAlreadyEnrolled ] = useState(true)
  ...
  return courseData ? (
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='top-0 left-0 absolute w-full h-section-height -z-1 
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='pt-4 md:text-base text-sm' 
            dangerouslySetInnerHTML={{__html : courseData.courseDescription.slice(0,202)}}></p>
           ...
           <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
              ...
              <div className='flex'>
                {[...Array(5)].map((_, i)=>(<img className='w-3.5 h-3.5' key={i} 
                    src={ i < Math.floor(calculateRating(courseData)) ? assets.star : assets.star_blank } alt='rating_star' />))}
              </div>
                  ...
                  {courseData.courseContent.map((chapter,index)=>(
                    ...
                    <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                      ...
                      <div onClick={()=>toggleSection(index)} className='flex items-center 
                        justify-between px-4 py-3 cursor-pointer select-none'>
        ...
        <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none
          ...
          
          {
            ...
            : <img src={courseData.courseThumbnail} alt="course-img" />
            ...
            <div className='p-5'>
              ...
              <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>
                {isAlreadyEnrollred ? 'Already Enrolled':'Enroll Now'}
              </button>
